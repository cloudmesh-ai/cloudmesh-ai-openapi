...
HOME_LINK='<div style="background: #f8f9fa; padding: 10px; border-bottom: 1px solid #ddd; text-align: left; width: 100%; position: sticky; top: 0; z-index: 1000;"><a href="/cloudmesh-ai-openapi/index.html" style="text-decoration: none; font-size: 1.2em; color: #007bff; font-weight: bold;"><img src="/cloudmesh-ai-openapi/assets/logo.png" style="height: 24px; vertical-align: middle; margin-right: 8px;" alt="Logo"> Home</a></div>'
find docs/api -name "*.html" -exec sed -i "" "s|<body>|<body>$HOME_LINK|" {} +
# Replace the default pdoc logo with our own logo
find docs/api -name "*.html" -exec sed -i "" "s|src=\"https://pdoc.dev/assets/logo.png\"|src=\"/cloudmesh-ai-openapi/assets/logo.png\"|" {} +
